 ...
 */
public class BlockBeltSlate extends Block {

    @SideOnly(Side.CLIENT)
    private IIcon beltSlateTop;

    @SideOnly(Side.CLIENT)
    private IIcon slateSides;

    public BlockBeltSlate(String unlocalizedName)
    {
        super(Material.rock);
        this.setCreativeTab(Archangel.tabCustom);
        this.setHardness(1.0F);
        this.setBlockName(unlocalizedName);
        this.setBlockTextureName(Ref.UNLOCALISED_BELTSLATE);
    ...
    {
        beltSlateTop = register.registerIcon(Ref.MOD_ID + ":" + Ref.UNLOCALISED_BELTSLATE);
